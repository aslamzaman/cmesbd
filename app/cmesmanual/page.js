    ...
    return (
        <>
            ...
            <div className="w-full border-2 border-gray-200 p-4 shadow-md rounded-md">
                <div className="w-full overflow-auto grid grid-cols-2 gap-4">
                    <iframe src="/cmesmanual/AccountingManualEnglish-06.03.14.pdf?#zoom=70" title="AccountingManualEnglish-06.03.14" className="w-full h-[850px] border-2 border-gray-400">noframes</iframe>
                    <iframe src="/cmesmanual/AccountingManualBangla-17.07.14.pdf?#zoom=70" title="AccountingManualBangla-17.07.14" className="w-full h-[850px] border-2 border-gray-400"></iframe>
