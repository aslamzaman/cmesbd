...
const Imagestopdf = () => {
    ...
    return (
        <>
            ...
            <div className="w-full lg:w-11/12 p-4 mx-auto mt-20 grid grid-cols-1 border-2 border-gray-400 shadow-lg rounded-lg">
                <form onSubmit={createPdfHandler}>
                    <div className="w-full grid grid-cols-2 lg:grid-cols-6 gap-2 border p-4">
