  ...
  const showEditForm = () => {
    ...
    const updateHandler = async (e) => {
        ...
        try {
            ...
            const msg = await updateDataToIndexedDB('sender', id, newObject);
            message(msg);
        } catch (error) {
                        ...
                        <div className="px-4 pb-6 text-black">
                            <form onSubmit={updateHandler} >
                                ...
                                <TextEn Title="Identify" Id="identify" Change={e => setIdentify(e.target.value)} Value={identify} Chr={150} />
                                    ...
                                    <TextEn Title="Number (Account Number)" Id="number" Change={e => setNumber(e.target.value)} Value={number} Chr={150} />
                                </div>
