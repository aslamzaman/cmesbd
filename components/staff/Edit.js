...
import { BtnSubmit, TextBn, TextEn } from "@/components/Form";
...
const Edit = ({ message, id, data }) => {
    ...
    const showEditForm = () => {
        ...
        setShow(true);
        try {
            const { nameEn, nameBn, postEn, postBn, address, mobile } = data;
            setNameEn(nameEn);
            setNameBn(nameBn);
            setPostEn(postEn);
            setPostBn(postBn);
                        ...
                        <div className="px-4 pb-6 text-black">
                            <form onSubmit={updateHandler} >
                                <div className="grid grid-cols-1 gap-4 my-4">
                                    ...
                                    <TextBn Title="Name (SutonnyMJ)" Id="nameBn" Change={e => setNameBn(e.target.value)} Value={nameBn} Chr={150} />
                                    <TextEn Title="Post (English)" Id="postEn" Change={e => setPostEn(e.target.value)} Value={postEn} Chr={150} />
                                    <TextBn Title="Post (SutonnyMJ)" Id="postBn" Change={e => setPostBn(e.target.value)} Value={postBn} Chr={150} />
